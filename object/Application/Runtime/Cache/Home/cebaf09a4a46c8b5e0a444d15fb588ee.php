...
<!-- saved from url=(0038)https://shop.vivo.com.cn/product/parts -->
...
<header id="header">
    <div class="head-search">
        <div class="search-box">
        	<form action="<?php echo U('Parts/Parts');?>" method="post" onsubmit="if ($.trim($(this).find('input').val()) == '') {alert('请输入关键词'); return false;} return true;"><input type="text" autocomplete="off" name="searchKeywordStr" maxlength="20" placeholder="如:x9"><button type="submit">搜索</button></form><a class="close"></a>
        </div>
    </div>
    <div class="wrapper">
        <nav id="navigator" class="cl">
        	<a href="<?php echo U('Index/index');?>" class="vivo-logo"><img src="/gitHub/tp_shop/object/Public/Home/Parts/vivo-logo_865fdf1.png" alt="vivo智能手机官方网站"></a>
            <ul class="cl">
                <li><a href="<?php echo U('Paging/paging');?>">手机</a></li>
                <li class="current"><a href="<?php echo U('Parts/parts');?>">配件</a></li>
                <li><a href="#">服务</a></li>
            </ul>
            ...
            <div class="filter">
                <div class="f-line">
                    <dl>
                        ...
                        <dd class="fl-item on"><a href="<?php echo U('Parts/parts');?>">全部</a></dd>
                            <?php if(is_array($parts)): foreach($parts as $key=>$v): ?><dd class="fl-item "><a href="<?php echo U('Parts/parts', array('id'=>$v['id']));?>"><?php echo ($v["name"]); ?></a></dd><?php endforeach; endif; ?>
                    </dl>
                </div>
                <div class="f-line sort">
                    <dl>
                        ...
                        <dd class="fl-item on">
                            <a href="<?php echo U('Parts/parts');?>">默认</a>
                        </dd>
                        <dd class="fl-item ">
                            <i>价格&nbsp;</i>
                            <a href="<?php echo U('Parts/parts?cost=1');?>">正序</a>
                            <i>/</i>
                            <a href="<?php echo U('Parts/parts?cost=2');?>">倒序</a>
                        </dd>
                        <dd class="fl-item ">
                            <i>上架时间&nbsp;</i>
                            <a href="<?php echo U('Parts/parts?grounding=1');?>">正序</a>
                            <i>／</i>
                            <a href="<?php echo U('Parts/parts?grounding=2');?>">倒序</a>
                        </dd>
                    </dl>
                </div>
            </div>
				<div class="list-box">
                    ...
                    <?php if(is_array($commodityParts)): foreach($commodityParts as $key=>$v): ?><li class="prod-item ">
    						...
    						<h3 title="<?php echo ($v["name"]); ?>">
    						<?php echo ($v["name"]); ?>
    						</h3>
    						<p class="price">
    							<dfn>¥</dfn><?php echo ($v["price"]); ?>
    						</p>
                        </a>
                ...
                <div class="pagination">
                        <span class=""><?php echo ($pages); ?> </span>
                        <!-- <div class="num"></div> -->
                </div>
