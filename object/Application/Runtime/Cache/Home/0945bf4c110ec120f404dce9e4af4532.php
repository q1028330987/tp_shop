...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="/gz25/github/tp_shop/object/Public/Personal/global_79a0974.css" rel="stylesheet" type="text/css">
    <link href="/gz25/github/tp_shop/object/Public/Personal/layout_3a0d4d9.css" rel="stylesheet" type="text/css">
    <link href="/gz25/github/tp_shop/object/Public/Personal/dialog_523c50b.css" rel="stylesheet" type="text/css">
        <link href="/gz25/github/tp_shop/object/Public/Personal/dialog_523c50b.css" rel="stylesheet" type="text/css">
        <link href="/gz25/github/tp_shop/object/Public/Personal/member-info_23053c5.css" rel="stylesheet" type="text/css">
        <link href="/gz25/github/tp_shop/object/Public/Personal/member-order_70818b2.css" rel="stylesheet" type="text/css">

    <link href="/gz25/github/tp_shop/object/Public/Personal/member-center_3bb3bfe.css" rel="stylesheet" type="text/css">
    <link href="/gz25/github/tp_shop/object/Public/Personal/member-index_45a1e7e.css" rel="stylesheet" type="text/css">
    <script src="/gz25/github/tp_shop/object/Public/Personal/hm.js" async=""></script>
    <script type="text/javascript" src="/gz25/github/tp_shop/object/Public/Personal/065f0df8c3a79510e698e5de40c8fb71.js"></script>
    <link href="/gz25/github/tp_shop/object/Public/Personal/member-address_0ef63f5.css" rel="stylesheet" type="text/css">
    <!--[if lt IE 9]>
    <script src="https://swsdl.vivo.com.cn/vivoshop/web/dist/js/bower_components/html5shiv/dist/html5shiv.min_23e126e.js"></script>
    <![endif]-->

<style type="text/css">#waf_nc_block {position: fixed;_position: absolute;width: 100%;height: 100%;top: 0;bottom: 0;left: 0;z-index: 9999;}.waf-nc-mask {background: #f8f8f8;opacity: 0.5;filter:alpha(opacity=50); width: 100%;height: 100%;} .waf-nc-wrapper {width:480px; height:254px; position: absolute; top: 50%; left: 50%; margin-top: -127px; margin-left: -240px; margin-bottom: 16px; background:#ffffff; border:3px solid #00A2CA;} .waf-nc-icon {position: absolute;top: 18px;left: 20px;} .waf-nc-title {margin-top: 23px; margin-left: 47px; font-size:16px; color:#333333; line-height:10px; text-align:left;} .waf-nc-splitter {margin-left: 26px; margin-top: 5px; width:430px; height:0px; border:1px solid #f4f4f4; } .waf-nc-description { margin-top: 22px; margin-left: 23px; font-size:12px; color:#333333; text-align: left; } #nocaptcha { margin-top: 20px; margin-left: 92px; width:300px; height36px;}</style><script src="/gz25/github/tp_shop/object/Public/Personal/nc.js">
</script>
</head>
...
<header id="header">
    ...
    <div class="wrapper">
        <nav id="navigator" class="cl">
        	<a href="<?php echo U('Index/Index');?>" class="vivo-logo"><img src="/gz25/github/tp_shop/object/Public/Personal/vivo-logo_865fdf1.png" alt="vivo智能手机官方网站"></a>
            <ul class="cl">
            ...
            <div class="search-user">
                <ul class="top-quick-menu">
                    ...
                    <li id="j_UserMenuTrigger">
                    	<a href="<?php echo U('Personal/personalpage');?>" class="user"><b><img src="/gz25/github/tp_shop/object/Public/Personal/small"></b></a>
                        <ul class="user-menu">
...
<aside class="menu-bar">
    <ul class="portrait-box">
        <li>
            ...
            <img width="160" src="/gz25/github/tp_shop/object/Public/Personal/big">
            </a>
        </li>
...
<dl>
    <dd class="module-item mem-overview">
        <h1 class="welcome-info">您好，<span class="name"><?php echo session('phone');?></span>，欢迎进入会员中心！</h1>
        <ul class="mem-properties">
            ...
            <!-- <li class="login-time"> -->
                <!-- 最近一次登录时间：2017-04-05 17:28</li> -->
        </ul>
        <div class="statistic-list">
            <ul>
                <li class="item">未付款订单<a href="javascript:;">0</a></li>
                <li class="item evaluation">评论和回复<a href="<?php echo U('Personal/remark');?>">0</a></li>
                <!-- <li class="item coupon">优惠券<a href="http://shop.vivo.com.cn/my/coupon">0</a></li> -->
            </ul>
        </div>
        </dd>
        </dl>
    ...
    <div class="footer-copyright">
        <div class="wrapper cl">
            <div class="sns-box">
                ...
                <a href="javascript:;" class="weixin"><b></b><div class="vivo-weixin-overbox"><img src="/gz25/github/tp_shop/object/Public/Personal/vivo-weixin-ico_f8c8800.jpg"><b></b></div></a>
            </div>
            <div class="copy-info">
        ...
        <li>
            <a class="qrcode">
                <div class="qrcode-container">
                    <img src="/gz25/github/tp_shop/object/Public/Personal/qrcode_6a6b792.png">
...
<script src="/gz25/github/tp_shop/object/Public/Personal/jquery.min_6163309.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/jquery.cookie_a5283b2.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/jquery.lazyload_546c1da.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/jquery-placeholder_fb6154c.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/vivo-common_38aa2f0.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/dialog_6a2b3fb.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/vivo-stat_265b49b.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/login_confirm_485e7b4.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/query-vcoin_32d1f89.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/shipping-address_35a72a8.js" type="text/javascript"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/dialog_6a2b3fb.js" type="text/javascript"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/jquery.validate.min_76c74f2.js"></script>
<script src="/gz25/github/tp_shop/object/Public/Personal/my_order_44f932e.js" type="text/javascript"></script>
<link href="/gz25/github/tp_shop/object/Public/Personal/buy-process_e40c238.css" rel="stylesheet" type="text/css">
