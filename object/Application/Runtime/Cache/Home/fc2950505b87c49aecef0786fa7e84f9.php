...
<body class="">
<div class="tip" style="width:100%;height:30px;background:green;position:fixed;top:0px;text-align:center;display:none;z-index:1000">
<span>商品已加入购物车</span>
</div>
<header id="header">
...
<!--                     <button class="btn-next J_buy-button btn-confirm now-buy" type="button" title="立即购买">立即购买</button>&nbsp;&nbsp;&nbsp; -->
                    <button class="btn-next J_buy-button btn-confirm now-buy" type="button" title="加入购物车" id="ShopCart" onclick="countGoods()">加入购物车</button>
        ...
        $.post(
            ...
            function (data) { 
                    ...
                    if (data == '1') { 
                        ...
                        $('.tip').slideDown(1000,'linear',function () { 
                            $(this).slideUp(1000,'swing');
                        });
                    }
