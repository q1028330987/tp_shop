...
<html lang="zh-CN"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>vivo Xplay6</title>
    <meta name="keywords" content="vivo Xplay6">
...
<link href="/gz25/github/tp_shop/object/Public/css/prod-detail_a0bd3da.css" rel="stylesheet" type="text/css">
<link href="/gz25/github/tp_shop/object/Public/css/dialog_523c50b.css" rel="stylesheet" type="text/css">
<style>
...
<style>
    ...
    #move{width:215px;height:215px;position:absolute;left:0px;top:0px;background:url('/gz25/github/tp_shop/object/Public/Home/picture/bg.png');cursor:move;visibility:hidden;}
...
<header id="header">
    <div class="head-search">
        <div class="search-box">
        	<form action="https://shop.vivo.com.cn/product/search" method="get"><input type="text" autocomplete="off" name="searchKeywordStr" maxlength="20" placeholder="如:x9"><button type="submit">搜索</button></form><a class="close"></a>
        </div>
    </div>
    <div class="wrapper">
        <nav id="navigator" class="cl">
        	<a href="<?php echo U('Index/index');?>" class="vivo-logo"><img src="/gz25/github/tp_shop/object/Public/Home/Details/vivo-logo_865fdf1.png" alt="vivo智能手机官方网站"></a>
            <ul class="cl">
        ...
        <div class="prod-container-top cl">
            <div class="prod-container-left">
                <?php if(is_array($details)): foreach($details as $key=>$v): ?><div class="product-album-pic"  id='small' >
                      <!-- 放大镜功能 -->
                      <img src="/gz25/github/tp_shop/object/Public<?php echo ($v['pic']); ?>" alt="" class="small-pic" id='smallImg' style='width:100%;height:100%;' goodsid="<?php echo ($v["id"]); ?>">
                      <div id='move'></div>
                </div>
                <img class="loading" app="b2c" src="/gz25/github/tp_shop/object/Public/Home/picture/loading.gif" alt="正在加载大图..." style="display:none;" />
                </div>

                <div id='big' style="background-color:#FAFAFA">
                <!-- 放大镜大图 -->
                    <img src="/gz25/github/tp_shop/object/Public<?php echo ($v['pic']); ?>" alt="" class="small-pic" id='bigImg' style="width:840px;height:100%px">
                </div><?php endforeach; endif; ?>
                <!-- <div id="j_SpecImgs" class="figure">
                    <ul id="bigImgUl">
                        <?php if(is_array($details)): foreach($details as $key=>$v): ?><li style="display: block; opacity: 1; z-index: 9;"><img src="/gz25/github/tp_shop/object/Public<?php echo ($v["pic"]); ?>" alt="商品图片"></li>
                            <li style="z-index: 1; opacity: 0; display: none;"><img src="/gz25/github/tp_shop/object/Public/Home/Details/4266_1490271072649hd_530x530.png" alt="商品图片"></li>
                            <li style="z-index: 1; opacity: 0; display: none;"><img src="/gz25/github/tp_shop/object/Public/Home/Details/4266_1490271073980hd_530x530.png" alt="商品图片"></li>
                            <li style="z-index: 1; opacity: 0; display: none;"><img src="/gz25/github/tp_shop/object/Public/Home/Details/4266_1490271075005hd_530x530.png" alt="商品图片"></li><?php endforeach; endif; ?>
                    </ul>
                </div> -->
                <!-- <div id="j_SpecItems" class="spec-items">
                    <ul class="cl" id="smallImgUl">
                        <?php if(is_array($details)): foreach($details as $key=>$v): ?><li class="current"><a href="javascript:;"><img src="/gz25/github/tp_shop/object/Public<?php echo ($v["pic"]); ?>"></a></li>
                            </div>
                        </li>
                    </ul>
                </div> -->
            ...
            <?php if(is_array($details)): foreach($details as $key=>$v): ?><h1><?php echo ($v["name"]); ?></h1>
                ...
                <form id="prod-detail-form" method="post">
                    <input type="hidden" id="spuId" name="spuId" value="9958">
                    <input type="hidden" id="cmdyCategoryId" name="cmdyCategoryId" value="139">
                ...
                <dl class="prod-params cl" id="j_colors" marketable="1">
                            ...
                            <dd class="package-box">
                                <ul class="tags package-tags cl J_package_tags">
                                    <li class="on" saleprice="4498">
                                        <h2 class="pkg-title">官方标配</h2>
                                        <p class="pkg-price"><dfn>¥</dfn>4498</p>
                                    </li>
                                    <li suitecode="148473273720681006" saleprice="6086">
                                        <h2 class="pkg-title">套餐一</h2>
                                        <p class="pkg-price"><dfn>¥</dfn>6086 <span class="blue"> 省<dfn>¥</dfn>300</span></p>
                                        <i class="icon-direction"></i>
                                    </li>
                                    <li suitecode="148643345204561756" saleprice="4647">
                                        <h2 class="pkg-title">套餐二</h2>
                                        <p class="pkg-price"><dfn>¥</dfn>4647 <span class="blue"> 省<dfn>¥</dfn>20</span></p>
                                        <i class="icon-direction"></i>
                                    </li>
                                    <li suitecode="148482219879561814" saleprice="4747">
                                        <h2 class="pkg-title">套餐三</h2>
                                        <p class="pkg-price"><dfn>¥</dfn>4747 <span class="blue"> 省<dfn>¥</dfn>20</span></p>
                                        <i class="icon-direction"></i>
                                    </li>
                                </ul>
                                ...
                                <div class="package-container hidden J_package_container">
                                    <table class="package-table hidden J_suite_table" suitecode="148473273720681006">
                                        <tbody><tr>
                                            <td class="main-prod">
                                                <img src="/gz25/github/tp_shop/object/Public/Home/Details/4266_1490271072649hd_250x250.png" alt="">
                                                <h3>Xplay6</h3>
                                            </td>
                                            ...
                                            <td class="ancillary-prods">
                                                <ul>
                                                    <li class="ancillary-prod J_bundle_sku_box">
                                                        <a href="https://shop.vivo.com.cn/product/9976" target="_blank">
                                                            <img class="ap-img" src="https://shop.vivo.com.cn/product/9958">
                                                        </a>
                                                        <h3>JBL Pulse2音乐脉动2</h3>
                                                        <div class="color-box J_bundle_sku_color">
                                                            <span style="background: #000000; " class="ap-color color-000000 J_enable selected" imgsrc="commodity/89/4189_1483103060895_250x250.png" title="黑色" bundleskuid="4189"></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </td>
                                    ...
                                    <table class="package-table hidden J_suite_table" suitecode="148643345204561756">
                                        <tbody><tr>
                                            ...
                                            <td class="ancillary-prods">
                                                <ul>
                                                    <li class="ancillary-prod J_bundle_sku_box">
                                                        <a href="https://shop.vivo.com.cn/product/9962" target="_blank">
                                                            <img class="ap-img" src="https://shop.vivo.com.cn/product/9958">
                                                        </a>
                                                        <h3>【乐心】智能手环 Mambo2</h3>
                                                        <div class="color-box J_bundle_sku_color">
                                                            <span style="background: #262626; " class="ap-color color-262626 J_enable selected" imgsrc="commodity/63/4163_1480331731031_250x250.png" title="黑色" bundleskuid="4163"></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </td>
                                    ...
                                    <table class="package-table hidden J_suite_table" suitecode="148482219879561814">
                                        <tbody><tr>
                                            ...
                                            <td class="ancillary-prods">
                                                <ul>
                                                    <li class="ancillary-prod J_bundle_sku_box">
                                                        <a href="https://shop.vivo.com.cn/product/9979" target="_blank">
                                                            <img class="ap-img" src="https://shop.vivo.com.cn/product/9958">
                                                        </a>
                                                        <h3>JBL GO 音乐金砖 蓝牙小音箱</h3>
                                                        <div class="color-box J_bundle_sku_color">
                                                            <span style="background: #31859b; " class="ap-color color-31859b J_enable selected" imgsrc="commodity/05/4205_1484807556682hd_250x250.png" title="蓝绿色" bundleskuid="4205"></span>
                                                            <span style="background: #ff0000; " class="ap-color color-ff0000 J_enable" imgsrc="commodity/04/4204_1484807538518hd_250x250.png" title="红色" bundleskuid="4204"></span>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </td>
                                ...
                                <dd>
                                        <ul class="tags service-tags">
                                                <li name="broken-svc" sku-id="9101" svc-price="158" broken-svc-id="187" title="此碎屏宝仅适用于双曲面屏Xplay5系列、Xplay6系列,请您和手机绑定购买或在购机3天内购买" class="broken">
                                                    【vivo服务】一年碎屏宝-曲面屏  <span class="item-price"><dfn>¥</dfn>158</span><i></i>
                                                </li>
                                                <li name="broken-svc" sku-id="9100" svc-price="128" broken-svc-id="204" title="此碎屏宝仅适用于双曲面屏Xplay5系列、Xplay6系列，请您和手机绑定购买或在购机3天内购买" class="broken">
                                                    【vivo服务】半年碎屏宝-曲面屏  <span class="item-price"><dfn>¥</dfn>128</span><i></i>
                                                </li>
                        ...
                        <dd id="j_installment" class="installment">
                            <div class="installment-label">花呗分期最低价</div><div class="installment-price blue" id="min-perpay"><dfn>¥</dfn>374.83*12期</div><label class="btn-show-more">更多</label>

                            <div class="installment-popup" style="display: none;">
                                <div class="popup-container">
                                    ...
                                    <div class="info-tip"><img src="/gz25/github/tp_shop/object/Public/Home/Details/icon-warning_f446f02.png">此处仅查看，请在收银台选择分期方案</div>
                                </div>
                ...
                <div class="btns">
                    ...
                    <button class="btn-next J_buy-button btn-confirm now-buy" type="button" title="立即购买">立即购买</button>&nbsp;&nbsp;&nbsp;
                    <button class="btn-next J_buy-button btn-confirm now-buy" type="button" title="立即购买">加入购物车</button>
...
<div class="prod-main-info" style="padding-top: 0px;">
    <div class="prod-main-tab">
        <div class="prod-tab-box">
            <button class="btn-next btn-confirm now-buy" type="button" title="立即购买" style="display: none;">立即购买</button>
            <div class="thumb-goods cl" style="display: none;">

                <div class="figure">
                        <li> <img id="j_smallPic" src="/gz25/github/tp_shop/object/Public/Home/Details/4266_1490338119910hd_250x250.png" width="45" height="45"></li>
></p><p><img data-src="https://swsdl.vivo.com.cn/vivoshop/commodity/20170323/20170323170513250257_original.jpg" style="display: inline;" src="/gz25/github/tp_shop/object/Public/Home/Details/20170323170513250257_original.jpg"></p><p><img data-src="https://swsdl.vivo.com.cn/vivoshop/commodity/20170329/20170329161716509617_original.jpg" title="" alt="" src="/gz25/github/tp_shop/object/Public/Home/Details/20170329161716509617_original.jpg" style="display: inline;"></p> -->
            <!-- <?php if(is_array($pics)): foreach($pics as $key=>$v): ?>-->
            <!-- <p><img title="" alt="图片被绑架了" src="/gz25/github/tp_shop/object/Public<?php echo ($v["imgs"]); ?>" style="display: inline;"></p> -->
        ...
        <div class="prod-main-evaluate" style="display: none;">
            <!-- 商品评价开始 -->
        </div>
    ...
    <div class="prod-afterservice-box wrapper">
        <ul class="cl">
            ...
            <li class="b2">
                <b></b>
                <h3>全国联网三包服务</h3>
                <p>由于产品本身出现性能故障（见国家规定的《移动电话机商品性能故障表》）， 顾客凭有效发票和有效三包凭证按照三包规定享受三包服务：自售出之日起7日退换货，一个月内包换，一年内保修。三包细则查询：<a href="https://shop.vivo.com.cn/helpcenter/service-promise" target="_blank">http://shop.vivo.com.cn/helpcenter/service-promise</a></p>
            </li>
            <li class="b5">
                <b></b>
                <h3>vivo售后服务点查询</h3>
...
<div id="side-bar">
    ...
    <script type="text/javascript">
      ...
      small.onmousemove = function(e){
        ...
        //一半儿的move的宽度
        var halfW = move.offsetWidth/2;
        var halfH = move.offsetHeight/2;

        var newLeft = x-_l-halfW-175;
        var newTop = y-_t-halfH-125;
        ...
        //获取比例
        var px = newLeft/small.offsetWidth;
        var py = newTop/small.offsetHeight;
        ...
        //获取大图距离左侧的距离
        var lf = bigImgWidth*px;
        var rg = bigImgHeight*py;

        //设置left属性
        bigImg.style.left = -lf+'px';
        bigImg.style.top = -rg +'px';
      ...
      small.onmouseout = function(){
        ...
        // console.log(getComputedStyle(move));
      }

      //绑定单击事件 来切换图片
      var img = document.getElementById('imgs').getElementsByTagName('img');
...
<script>
    ...
    // console.log('整个文档的高度'+documentHeight);
    ...
    $(document).on('scroll', function () {
        ...
        // console.log('浏览器窗口可见高度'+browserHeight);
        ...
        //获取到商品的id号
        var goodsid = $('.small-pic').attr('goodsid');
            ...
            $.post(
                ...
                function (data) {
                    ...
                    for ( var i = 0; i < data.length; i++ ) {
                        // console.log(data);
                        ter += '<p><img title="" alt="图片被绑架了" src="/gz25/github/tp_shop/object/Public'+data[i]['imgs']+'" style="display: inline;"></p>';
                    }
                    $('.section').append(ter);
                },
                'json'
        ...
        //当滚动条到底部了
        if ( scrollHeight + browserHeight >= documentHeight ) {

            // console.log('好深！到底啦！不要不要');
        }
    });
</script>


<script src="/gz25/github/tp_shop/object/Public/js/simpleStorage_f115cd4.js"></script>
<script src="/gz25/github/tp_shop/object/Public/js/view_cbc6422.js"></script>
<script src="/gz25/github/tp_shop/object/Public/js/view-hist_823c137.js"></script>
<script src="/gz25/github/tp_shop/object/Public/js/dialog_6a2b3fb.js" type="text/javascript"></script>
