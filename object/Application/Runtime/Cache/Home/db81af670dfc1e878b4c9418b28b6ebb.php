...
<!-- saved from url=(0038)https://shop.vivo.com.cn/product/phone -->
            ...
            <div class="filter">
                <div class="f-line">
                    <dl>
                        <dt class="fl-title fl-item">分类：</dt>
                            <dd class="fl-item on"><a href="<?php echo U('Paging/paging');?>">全部</a></dd>
                            <?php if(is_array($paging)): foreach($paging as $key=>$v): ?><dd class="fl-item "><a href="<?php echo U('Paging/paging', array('id'=>$v['id']));?>"><?php echo ($v["name"]); ?></a></dd><?php endforeach; endif; ?>
                    </dl>
                </div>
                <div class="f-line sort">
                    <dl>
                        ...
                        <dd class="fl-item on">
							<a href="<?php echo U('Paging/paging');?>">默认</a>
						</dd>
                        <dd class="fl-item ">
                            <i>价格&nbsp;</i>
							<a href="<?php echo U('Paging/paging?cost=1');?>">正序</a>
                            <i>/</i>
                            <a href="<?php echo U('Paging/paging?cost=2');?>">倒序</a>
						</dd>
                        <dd class="fl-item ">
                            <i>上架时间&nbsp;</i>
							<a href="<?php echo U('Paging/paging?grounding=1');?>">正序</a>
                            <i>／</i>
                            <a href="<?php echo U('Paging/paging?grounding=2');?>">倒序</a>
						</dd>
                    </dl>
                </div>
            </div>
