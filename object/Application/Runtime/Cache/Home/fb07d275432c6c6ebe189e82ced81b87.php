...
<div>
    ...
    <?php if(is_array($list)): foreach($list as $key=>$v): ?><table class="order-table">
                <colgroup>
                    <col width="155">
                    <col>
                    <col class="col1">
                ...
                <tr>
                    <th colspan="6" class="order-title">
                        <ul>
                            <li class="order-number">订单号：<a href=""><?php echo ($v["id"]); ?></a>
                            </li>
                ...
                <tbody><tr class="order-line">
                    <td colspan="4">
                        <table class="order-sub-table">
                            <colgroup>
                                ...
                                <tr class="prod-line">
                                    <td class="prod-pic">
                                        <a class="figure" href="" target="_blank"><img src="" alt=""></a>
                                    </td>
                                    <td colspan="3">
                                        <table class="prods-info-table">
                                            ...
                                            <tr class="prod-info">
                                                <td class="prod-name" colspan="2">
                                                    <a href="" target="_blank" title=""><?php echo ($v["name"]); ?></a>
                                                       <!--  <br>地址：<?php echo ($v["address"]); ?> -->
                                                        <li>地址：<?php echo ($v["address"]); echo ($v["province"]); echo ($v["city"]); echo ($v["area"]); ?></li>
                                                        <li>收货人：<?php echo ($v["recname"]); ?></li>
                                                        <li>联系电话：<?php echo ($v["recphone"]); ?></li>
                                                </td>
                    ...
                    <td class="status"><?php echo ($v["status"]); ?></td>
                    <td class="operation">
                        <ul>
                            <button value="<?php echo ($v["status"]); ?>" onClick="changestatus()">付款</button>
                            <!-- <span value="<?php echo ($v["status"]); ?>" onClick="changestatus()"></span> -->
                        </ul>
                    </td>
                </tr>
