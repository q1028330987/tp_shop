...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">vivo后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover">
						...
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="#">切换账户</a></li>
							<li><a href="<?php echo U('Admin/admin_logout');?>">退出</a></li>
					</ul>
				</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Orders/orders_list');?>" data-title="订单管理" href="javascript:void(0)">订单管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
