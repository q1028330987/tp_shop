...
<link rel="Bookmark" href="/gz25/vivo/tp_shop/object/Public/favicon.ico" >
<link rel="Shortcut Icon" href="/gz25/vivo/tp_shop/object/Public/favicon.ico" />
<!--[if lt IE 9]>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('member_list');?>" data-title="会员列表" href="javascript:;">会员列表</a></li>
					<li><a data-href="<?php echo U('member_record_browse');?>" data-title="浏览记录" href="javascript:void(0)">会员地址</a></li>
					<li><a data-href="<?php echo U('member_record_download');?>" data-title="下载记录" href="javascript:void(0)">下载记录</a></li>
					<li><a data-href="<?php echo U('member_record_share');?>" data-title="分享记录" href="javascript:void(0)">分享记录</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/gz25/vivo/tp_shop/object/Public/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
