...
<article class="page-container">
	<form action="<?php echo U('Admin/Admin/admin_permission_add');?>" class="form form-horizontal" id="form-admin-add" method="post" >
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>控制器名：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="name" name="name">
			<input type="hidden" id="name_hidden" value="0" />
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>权限节点：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="" placeholder="例：Admin/Goods/Add" id="title" name="title">
		</div>
	</div>
<!-- 	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off"  placeholder="确认密码" id="repass" name="repass">
		</div>
	</div> -->
	<!-- <div class="row cl">
...
<!-- 	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="group_id" size="1">
				...
				<option value="1">客服部门</option>
				<option value="2">商品管理组</option>
				<?php if(is_array($res)): foreach($res as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["role"]); ?></option><?php endforeach; endif; ?>
			</select>
			</span> </div>
	</div> -->
	<!-- <div class="row cl">
