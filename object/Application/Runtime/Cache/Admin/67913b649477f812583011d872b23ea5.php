...
<article class="page-container">
	<form action="<?php echo U('Admin/Admin/admin_edit');?>" class="form form-horizontal" id="form-admin-add" method="post">
	<div class="row cl" uid="">
		<input type="hidden" id="admin_edit" value="">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="name" name="name" disabled="none">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>初始密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="" placeholder="密码" id="oldpass" name="oldpass">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>修改密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off"  placeholder="确认新密码" id="newpass" name="newpass" onmouseleave="">
		</div>
	</div>
	<!-- <div class="row cl">
