...
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
<?php if(is_array($orderList)): foreach($orderList as $key=>$v): ?><tr class="text-c">
					<td><input type="checkbox" value="" name=""></td>
					<td><?php echo ($v["id"]); ?></td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看"><?php echo ($v["province"]); echo ($v["city"]); echo ($v["area"]); echo ($v["address"]); ?></u></td>
					<td><?php echo ($v["name"]); ?></td>
					<td><?php echo ($v["recphone"]); ?></td>
					<td><?php echo (date("Y-m-d H:i:s", $v["addtime"])); ?></td>
					<td>¥<?php echo ($v["total"]); ?>.00</td>
