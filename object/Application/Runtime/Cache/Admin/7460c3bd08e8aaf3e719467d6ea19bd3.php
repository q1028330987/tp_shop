			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr class="text-c va-m">
							<td><?php echo ($v["id"]); ?></td>
							<td><a onClick="product_show('商品详情图','product_show.html?id=<?php echo ($v["id"]); ?>','<?php echo ($v["id"]); ?>')" href="javascript:;" title="商品详情图"><img width="60" class="product-thumb" src="/gz25/github/tp_shop/object/Public<?php echo ($v["pic"]); ?>"></a></td>
