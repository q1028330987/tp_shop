...
<!--[if IE 6]>
<script type="text/javascript" src="/gz25/github/tp_shop/object/Publiclib/DD_belatedPNG_0.0.8a-min.js" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
<title>商品列表</title>
<link rel="stylesheet" href="/gz25/github/tp_shop/object/Public/lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
</head>
<body class="pos-r">
...
<div style="margin-left:200px;">
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="<?php echo U('Goods/add');?>"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr class="text-c va-m">
							...
							<td><?php echo ($v["id"]); ?></td>
							<td><a onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img width="60" class="product-thumb" src="/gz25/github/tp_shop/object/Public/<?php echo ($v["pic"]); ?>"></a></td>
							<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><span><?php echo ($v["name"]); ?></span></td>
							...
							<td class="td-manage">
								...
								<a style="text-decoration:none" class="ml-5" onClick="product_add('参数编辑','product_add.html','10001')" href="<?php echo U('Goods/product_add',array('id'=>$v['id']));?>" title="参数"><i class="ico-cogs">&#xe6de;</i>
								<a style="text-decoration:none" class="ml-5" onClick="product_edit('商品编辑','product-add.html','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/gz25/github/tp_shop/object/Public/lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script>
