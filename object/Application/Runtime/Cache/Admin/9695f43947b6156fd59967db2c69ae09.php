	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
				...
				<td class="td-manage"><a style="text-decoration:none" onClick="member_stop(this,<?php echo ($vo["id"]); ?>)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','member-add.html','<?php echo ($vo["id"]); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','change-password.html','<?php echo ($vo["id"]); ?>','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a> <a title="删除" href="<?php echo U('Admin/Member/member_del',array('id'=>$vo['id']));?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			<!-- <?php echo U('Admin/Member/member_passchange',array('id'=>$vo['id']));?> --><?php endforeach; endif; ?>  
		</tbody>
	</table>
	</div>
</div>
...
function member_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo U("Admin/member_stop");?>',
			dataType: 'json',
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		// $.ajax({
		// 	type: 'POST',
		// 	url: '<?php echo U("Admin/member_start");?>',
		// 	dataType: 'json',
		// 	success: function(data){
				$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="member_stop(this,<?php echo ($vo["id"]); ?>)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>');
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.ajax({
			type: 'POST',
			url: '<?php echo U("Admin/member_del");?>',
			dataType: 'json',
			success: function(data){
