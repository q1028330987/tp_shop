...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户中心 <span class="c-gray en">&gt;</span> 地址列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
					...
					<td><?php echo ($vo["recname"]); ?></td>
					<td><?php echo ($vo["recphone"]); ?></td>
					<!-- <td><?php echo ($vo["email"]); ?></td> -->
					<td><?php echo ($vo["province"]); echo ($vo["city"]); echo ($vo["area"]); echo ($vo["address"]); ?></td>
					<td class="f-14"><a title="删除" href="<?php echo U('Member/address_del',array('id'=>$vo['id']));?>" onclick="user_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
