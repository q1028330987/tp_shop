...
<div class="page-container">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<?php if(is_array($wheelshow)): foreach($wheelshow as $key=>$v): ?><tr class="text-c">
					<td><?php echo ($v["id"]); ?></td>
					<td>
						<img width="192px" height="60px" class="picture-thumb" src="/gitHub/tp_shop/object/Public<?php echo ($v['pic']); ?>">
					</td>
					<td class="text-l">
						<?php echo ($v["title"]); ?>
					</td>
					...
					<td class="td-manage">
						...
						<a style="text-decoration:none" class="ml-5" href="<?php echo U('Wheel/delete',array('id'=>$v['id']));?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
